...
@ROUTER.get('/sellers')
def get_sellers(auction_controller: AuctionController = get_controller('AuctionController')):
    """Returns sellers list"""
    return auction_controller.get_unique_companies(CompanyType.seller)

@ROUTER.get('/buyers')
def get_buyers(auction_controller: AuctionController = get_controller('AuctionController')):
    """Returns buyers list"""
